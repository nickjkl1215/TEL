                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{url('clientes/atualizar')}}/{{ $cliente->id }}" method="post" class="row g-3">
                        ...
                        <div class="col-md-6">
                          ...
                          <input maxlength="50"  name="name" type="text" class="form-control" id="inputEmail4" value="{{$cliente->name}}">
                        </div>
                        <div class="col-md-6">
                          <label for="inputPassword4" class="form-label">CPF</label>
                          <input  name="cpf" maxlength="14" type="text" class="form-control" id="inputPassword4" value="{{$cliente->cpf}}">
                        </div>
                        <div class="col-md-6">
                          <label for="inputAddress" class="form-label">RG</label>
                          <input name="rg" maxlength="12" type="text" class="form-control" id="inputAddress" value="{{$cliente->rg}}">
                          @error('rg')
                        ...
                        <div class="col-md-6">
                          ...
                          <input name="data_de_nascimento" min="1900-01-01" max="2021-01-01" type="text" class="form-control" id="inputAddress2" value="{{$cliente->data_de_nascimento}}">
                        ...
                        <div class="col-md-6">
                          ...
                          <input name="telefone" maxlength="15" type="text" class="form-control" id="inputCity" value="{{$cliente->telefone}}">
                        </div>
                        <div class="col-md-4">
                    ...
                    <form action="{{url('clientes/adicionar')}}" method="post" class="row g-3">
                        ...
                        <div class="col-md-6">
                          <label for="inputEmail4" class="form-label">Nome</label>
                          <input maxlength="50" name="name" type="text" class="form-control" id="inputEmail4">
                        </div>
                        <div class="col-md-6">
                          <label for="inputPassword4" class="form-label">CPF</label>
                        ...
                        <div class="col-md-6">
                          <label for="inputCity" class="form-label">Telefone</label>
                          <input name="telefone" maxlength="15" type="text" class="form-control" id="inputCity">
                        </div>
                        <div class="col-md-4">
                          <label for="inputState" class="form-label">Local de Nascimento</label>
                          <select maxlength="15" name="local_nascimento" id="inputState" class="form-select">
                            <option selected>Cidade...</option>
                            <option>Bahia</option>
                            <option>São Paulo</option>
                          </select>
